...
import { LayoutGrid, Brain, Smile, Layers, MessageSquare, LogOut } from 'lucide-react'
  ...
  return (
    <div className={cn('flex flex-col h-screen border-r bg-white', className)}>
      ...
      <div className="p-4 border-t">
        ...
        <Link
          to="/logout"
          className="flex items-center gap-3 px-3 py-2 mt-2 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100"
        >
