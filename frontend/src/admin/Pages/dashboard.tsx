...
import { StatsCard } from '@/admin/components/dashboard/stats-card'
import { ActivityList } from '@/admin/components/dashboard/activity-list'
import { SystemOverview } from '@/admin/components/dashboard/system-overview'
